...
describe('BuildComponent', () => {
  ...
  it('get all ingredients', () => {
    ...
    const req = httpTestingController.expectOne('http://localhost:5500/Build');
  ...
  it('should build Pizza', () => {
    ...
    service.postIngredients(mockCart).subscribe((result:{status: Boolean,msg:String}) => {
